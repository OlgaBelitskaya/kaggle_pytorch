# -*- coding: utf-8 -*-
"""pytorch-practice-9.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1R-0C6gMoPq9y7HqW8AHqBOVKH1FdrMHy
...
class VGG16(tnn.Module):
    def __init__(self,num_classes):
        ...
        self.classifier=tnn.Sequential(
            tnn.Linear(512*2*2,4096),tnn.ReLU(),   
...
[[x_train,x_valid,x_test],
 [y_train,y_valid,y_test]]=\
resize_display(x_train,y_train,x_test,y_test,64)
...
num_classes=2; learning_rate=.0005
